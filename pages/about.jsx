        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("poojapithva2205@gmail.com")
                }
                ...
                href="mailto:poojapithva2205@gmail.com"
              >
                {" "}
                poojapithva2205@gmail.com
              </a>{" "}
              or <span className="text-blue-700 font-bold">LinkedIn</span>{" "}
              <a
                href="http://linkedin.com/in/poojapithva"
              ...
              <a
                href="https://instagram.com/_pooojjaa"
                target="blank"
                rel="noopener noreferrer"
