        ...
        <div className="lg:h-screen 2xl:h-max max-w-[90rem] mx-auto">
          ...
          <div className="mt-12 text-base md:text-xl lg:text-xl xl:text-xl 2xl:text-xl">
            <p className="sm:leading-6 md:leading-6 lg:leading-8">
              ...
              creativity, and a lot of coffee! I’m all about making the UI feel
              like magic—a perfect blend of form and function that just clicks.
              When I’m not coding, I’m dreaming up new ways to bring elegance,
